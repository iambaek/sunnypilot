...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if not self.CP.pcmCruiseSpeed and (self.frame - self.last_button_frame)*DT_CTRL > 0.1:
      ...
      if self.cruise_button is not None and button_counter_offset is not None:
